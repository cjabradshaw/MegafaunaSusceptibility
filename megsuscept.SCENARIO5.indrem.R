...
##############################################################################################
## SCENARIO 5: PROGRESSIVELY REMOVE INCREASING NUMBER OF INDIVIDUALS RANDOMLY FROM N VECTOR ##
##############################################################################################
...
ind.rem.vec <- c(0, round(10^seq(1,5,0.1), 0))
DP.Q.ext.pr <- PA.Q.ext.pr <- ZT.Q.ext.pr <-  PH.Q.ext.pr <- VU.Q.ext.pr <- PG.Q.ext.pr <- SS.Q.ext.pr <- PT.Q.ext.pr <- SO.Q.ext.pr <- MN.Q.ext.pr <- OR.Q.ext.pr <- NR.Q.ext.pr <- GN.Q.ext.pr <- DN.Q.ext.pr <- AL.Q.ext.pr <- TC.Q.ext.pr <- TH.Q.ext.pr <- SH.Q.ext.pr <- DM.Q.ext.pr <- TA.Q.ext.pr <- MR.Q.ext.pr <- rep(NA,length(ind.rem.vec))
...
for (k in 1:length(ind.rem.vec)) {
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      DP.n.mat[,i+1] <- ifelse((DP.n.mat[,i+1] - round((ind.rem.vec[k]*DP.ssd),0)) < 0, 0, (DP.n.mat[,i+1] - round((ind.rem.vec[k]*DP.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      PA.n.mat[,i+1] <- ifelse((PA.n.mat[,i+1] - round((ind.rem.vec[k]*PA.ssd),0)) < 0, 0, (PA.n.mat[,i+1] - round((ind.rem.vec[k]*PA.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      ZT.n.mat[,i+1] <- ifelse((ZT.n.mat[,i+1] - round((ind.rem.vec[k]*ZT.ssd),0)) < 0, 0, (ZT.n.mat[,i+1] - round((ind.rem.vec[k]*ZT.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      PH.n.mat[,i+1] <- ifelse((PH.n.mat[,i+1] - round((ind.rem.vec[k]*PH.ssd),0)) < 0, 0, (PH.n.mat[,i+1] - round((ind.rem.vec[k]*PH.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      VU.n.mat[,i+1] <- ifelse((VU.n.mat[,i+1] - round((ind.rem.vec[k]*VU.ssd),0)) < 0, 0, (VU.n.mat[,i+1] - round((ind.rem.vec[k]*VU.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      PG.n.mat[,i+1] <- ifelse((PG.n.mat[,i+1] - round((ind.rem.vec[k]*PG.ssd),0)) < 0, 0, (PG.n.mat[,i+1] - round((ind.rem.vec[k]*PG.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      SS.n.mat[,i+1] <- ifelse((SS.n.mat[,i+1] - round((ind.rem.vec[k]*SS.ssd),0)) < 0, 0, (SS.n.mat[,i+1] - round((ind.rem.vec[k]*SS.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      PT.n.mat[,i+1] <- ifelse((PT.n.mat[,i+1] - round((ind.rem.vec[k]*PT.ssd),0)) < 0, 0, (PT.n.mat[,i+1] - round((ind.rem.vec[k]*PT.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      SO.n.mat[,i+1] <- ifelse((SO.n.mat[,i+1] - round((ind.rem.vec[k]*SO.ssd),0)) < 0, 0, (SO.n.mat[,i+1] - round((ind.rem.vec[k]*SO.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      MN.n.mat[,i+1] <- ifelse((MN.n.mat[,i+1] - round((ind.rem.vec[k]*MN.ssd),0)) < 0, 0, (MN.n.mat[,i+1] - round((ind.rem.vec[k]*MN.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      OR.n.mat[,i+1] <- ifelse((OR.n.mat[,i+1] - round((ind.rem.vec[k]*OR.ssd),0)) < 0, 0, (OR.n.mat[,i+1] - round((ind.rem.vec[k]*OR.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      NR.n.mat[,i+1] <- ifelse((NR.n.mat[,i+1] - round((ind.rem.vec[k]*NR.ssd),0)) < 0, 0, (NR.n.mat[,i+1] - round((ind.rem.vec[k]*NR.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      GN.n.mat[,i+1] <- ifelse((GN.n.mat[,i+1] - round((ind.rem.vec[k]*GN.ssd),0)) < 0, 0, (GN.n.mat[,i+1] - round((ind.rem.vec[k]*GN.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      DN.n.mat[,i+1] <- ifelse((DN.n.mat[,i+1] - round((ind.rem.vec[k]*DN.ssd),0)) < 0, 0, (DN.n.mat[,i+1] - round((ind.rem.vec[k]*DN.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      AL.n.mat[,i+1] <- ifelse((AL.n.mat[,i+1] - round((ind.rem.vec[k]*AL.ssd),0)) < 0, 0, (AL.n.mat[,i+1] - round((ind.rem.vec[k]*AL.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      TC.n.mat[,i+1] <- ifelse((TC.n.mat[,i+1] - round((ind.rem.vec[k]*TC.ssd),0)) < 0, 0, (TC.n.mat[,i+1] - round((ind.rem.vec[k]*TC.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      TH.n.mat[,i+1] <- ifelse((TH.n.mat[,i+1] - round((ind.rem.vec[k]*TH.ssd),0)) < 0, 0, (TH.n.mat[,i+1] - round((ind.rem.vec[k]*TH.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      SH.n.mat[,i+1] <- ifelse((SH.n.mat[,i+1] - round((ind.rem.vec[k]*SH.ssd),0)) < 0, 0, (SH.n.mat[,i+1] - round((ind.rem.vec[k]*SH.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      DM.n.mat[,i+1] <- ifelse((DM.n.mat[,i+1] - round((ind.rem.vec[k]*DM.ssd),0)) < 0, 0, (DM.n.mat[,i+1] - round((ind.rem.vec[k]*DM.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      TA.n.mat[,i+1] <- ifelse((TA.n.mat[,i+1] - round((ind.rem.vec[k]*TA.ssd),0)) < 0, 0, (TA.n.mat[,i+1] - round((ind.rem.vec[k]*TA.ssd),0))) # remove animals following ssd
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      MR.n.mat[,i+1] <- ifelse((MR.n.mat[,i+1] - round((ind.rem.vec[k]*MR.ssd),0)) < 0, 0, (MR.n.mat[,i+1] - round((ind.rem.vec[k]*MR.ssd),0))) # remove animals following ssd
...
DP.auc <- sum(sum(DP.Q.ext.pr)/length(ind.rem.vec))
PA.auc <- sum(sum(PA.Q.ext.pr)/length(ind.rem.vec))
ZT.auc <- sum(sum(ZT.Q.ext.pr)/length(ind.rem.vec))
PH.auc <- sum(sum(PH.Q.ext.pr)/length(ind.rem.vec))
VU.auc <- sum(sum(VU.Q.ext.pr)/length(ind.rem.vec))
PG.auc <- sum(sum(PG.Q.ext.pr)/length(ind.rem.vec))
SS.auc <- sum(sum(SS.Q.ext.pr)/length(ind.rem.vec))
PT.auc <- sum(sum(PT.Q.ext.pr)/length(ind.rem.vec))
SO.auc <- sum(sum(SO.Q.ext.pr)/length(ind.rem.vec))
MN.auc <- sum(sum(MN.Q.ext.pr)/length(ind.rem.vec))
OR.auc <- sum(sum(OR.Q.ext.pr)/length(ind.rem.vec))
NR.auc <- sum(sum(NR.Q.ext.pr)/length(ind.rem.vec))
GN.auc <- sum(sum(GN.Q.ext.pr)/length(ind.rem.vec))
DN.auc <- sum(sum(DN.Q.ext.pr)/length(ind.rem.vec))
AL.auc <- sum(sum(AL.Q.ext.pr)/length(ind.rem.vec))
TC.auc <- sum(sum(TC.Q.ext.pr)/length(ind.rem.vec))
TH.auc <- sum(sum(TH.Q.ext.pr)/length(ind.rem.vec))
SH.auc <- sum(sum(SH.Q.ext.pr)/length(ind.rem.vec))
DM.auc <- sum(sum(DM.Q.ext.pr)/length(ind.rem.vec))
TA.auc <- sum(sum(TA.Q.ext.pr)/length(ind.rem.vec))
MR.auc <- sum(sum(MR.Q.ext.pr)/length(ind.rem.vec))
...
Qextpr.dat <- data.frame(ind.rem.vec,DP.Q.ext.pr,PA.Q.ext.pr,ZT.Q.ext.pr,PH.Q.ext.pr,VU.Q.ext.pr,PG.Q.ext.pr,SS.Q.ext.pr,PT.Q.ext.pr,SO.Q.ext.pr,MN.Q.ext.pr,OR.Q.ext.pr,NR.Q.ext.pr,GN.Q.ext.pr,DN.Q.ext.pr,AL.Q.ext.pr,TC.Q.ext.pr,TH.Q.ext.pr,SH.Q.ext.pr,DM.Q.ext.pr,TA.Q.ext.pr,MR.Q.ext.pr)
...
write.table(Qextpr.dat, file="indremQpr.csv", sep=",", dec = ".", row.names = F, col.names = T)
write.table(dat.out, file="indremout.csv", sep=",", dec = ".", row.names = T, col.names = T)

save.image("indrem.RData")
