...
###################################################
## SCENARIO 3: PROGRESSIVELY DECREASE FERTILITY  ##
###################################################
...
fert.red.vec <- seq(0, 0.975, 0.025)
DP.Q.ext.pr <- PA.Q.ext.pr <- ZT.Q.ext.pr <-  PH.Q.ext.pr <- VU.Q.ext.pr <- PG.Q.ext.pr <- SS.Q.ext.pr <- PT.Q.ext.pr <- SO.Q.ext.pr <- MN.Q.ext.pr <- OR.Q.ext.pr <- NR.Q.ext.pr <- GN.Q.ext.pr <- DN.Q.ext.pr <- AL.Q.ext.pr <- TC.Q.ext.pr <- TH.Q.ext.pr <- SH.Q.ext.pr <- DM.Q.ext.pr <- TA.Q.ext.pr <- MR.Q.ext.pr <- rep(NA,length(fert.red.vec))

for (k in 1:length(fert.red.vec)) {
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      DP.fert.stch <- rnorm(length(DP.popmat[,1]), DP.pred.p.mm, DP.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      PA.fert.stch <- rnorm(length(PA.popmat[,1]), PA.pred.p.mm, PA.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      ZT.fert.stch <- rnorm(length(ZT.popmat[,1]), ZT.pred.p.mm, ZT.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      PH.fert.stch <- rnorm(length(PH.popmat[,1]), PH.pred.p.mm, PH.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      VU.fert.stch <- rnorm(length(VU.popmat[,1]), VU.pred.p.mm, VU.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      PG.fert.stch <- rnorm(length(PG.popmat[,1]), PG.pred.p.mm, PG.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      SS.fert.stch <- rnorm(length(SS.popmat[,1]), SS.pred.p.mm, SS.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      PT.fert.stch <- rnorm(length(PT.popmat[,1]), PT.pred.p.mm, PT.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      SO.fert.stch <- rnorm(length(SO.popmat[,1]), SO.pred.p.mm, SO.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      MN.fert.stch <- rnorm(length(MN.popmat[,1]), MN.pred.p.mm, MN.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      OR.fert.stch <- rnorm(length(OR.popmat[,1]), OR.pred.p.mm, OR.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      NR.fert.stch <- rnorm(length(NR.popmat[,1]), NR.pred.p.mm, NR.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      GN.fert.stch <- rnorm(length(GN.popmat[,1]), GN.pred.p.mm, GN.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      DN.fert.stch <- rnorm(length(DN.popmat[,1]), DN.pred.p.mm, DN.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      AL.fert.stch <- rnorm(length(AL.popmat[,1]), AL.pred.p.mm, AL.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      TC.fert.stch <- rnorm(length(TC.popmat[,1]), TC.pred.p.mm, TC.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      TH.fert.stch <- rnorm(length(TH.popmat[,1]), TH.pred.p.mm, TH.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      SH.fert.stch <- rnorm(length(SH.popmat[,1]), SH.m.vec, SH.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      DM.fert.stch <- rnorm(length(DM.popmat[,1]), DM.m.vec, DM.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      TA.fert.stch <- rnorm(length(TA.popmat[,1]), TA.pred.p.mm, TA.m.sd.vec) * (1 - fert.red.vec[k])
  ...
  for (e in 1:iter) {
    ...
    for (i in 1:t) {
      ...
      # stochastic fertilty sampler (gaussian)
      MR.fert.stch <- rnorm(length(MR.popmat[,1]), MR.pred.p.mm, MR.m.sd.vec) * (1 - fert.red.vec[k])
...
DP.auc <- sum(sum(DP.Q.ext.pr)/length(fert.red.vec))
PA.auc <- sum(sum(PA.Q.ext.pr)/length(fert.red.vec))
ZT.auc <- sum(sum(ZT.Q.ext.pr)/length(fert.red.vec))
PH.auc <- sum(sum(PH.Q.ext.pr)/length(fert.red.vec))
VU.auc <- sum(sum(VU.Q.ext.pr)/length(fert.red.vec))
PG.auc <- sum(sum(PG.Q.ext.pr)/length(fert.red.vec))
SS.auc <- sum(sum(SS.Q.ext.pr)/length(fert.red.vec))
PT.auc <- sum(sum(PT.Q.ext.pr)/length(fert.red.vec))
SO.auc <- sum(sum(SO.Q.ext.pr)/length(fert.red.vec))
MN.auc <- sum(sum(MN.Q.ext.pr)/length(fert.red.vec))
OR.auc <- sum(sum(OR.Q.ext.pr)/length(fert.red.vec))
NR.auc <- sum(sum(NR.Q.ext.pr)/length(fert.red.vec))
GN.auc <- sum(sum(GN.Q.ext.pr)/length(fert.red.vec))
DN.auc <- sum(sum(DN.Q.ext.pr)/length(fert.red.vec))
AL.auc <- sum(sum(AL.Q.ext.pr)/length(fert.red.vec))
TC.auc <- sum(sum(TC.Q.ext.pr)/length(fert.red.vec))
TH.auc <- sum(sum(TH.Q.ext.pr)/length(fert.red.vec))
SH.auc <- sum(sum(SH.Q.ext.pr)/length(fert.red.vec))
DM.auc <- sum(sum(DM.Q.ext.pr)/length(fert.red.vec))
TA.auc <- sum(sum(TA.Q.ext.pr)/length(fert.red.vec))
MR.auc <- sum(sum(MR.Q.ext.pr)/length(fert.red.vec))
...
Qextpr.dat <- data.frame(fert.red.vec,DP.Q.ext.pr,PA.Q.ext.pr,ZT.Q.ext.pr,PH.Q.ext.pr,VU.Q.ext.pr,PG.Q.ext.pr,SS.Q.ext.pr,PT.Q.ext.pr,SO.Q.ext.pr,MN.Q.ext.pr,OR.Q.ext.pr,NR.Q.ext.pr,GN.Q.ext.pr,DN.Q.ext.pr,AL.Q.ext.pr,TC.Q.ext.pr,TH.Q.ext.pr,SH.Q.ext.pr,DM.Q.ext.pr,TA.Q.ext.pr,MR.Q.ext.pr)
colnames(Qextpr.dat) <- c("Fred",labs.vec)
dat.out <- data.frame(spp.mass.vec, Qext.auc)
colnames(dat.out) <- c("M","AUC")
rownames(dat.out) <- labs.vec

write.table(Qextpr.dat, file="fertredQpr.csv", sep=",", dec = ".", row.names = F, col.names = T)
write.table(dat.out, file="fertredout.csv", sep=",", dec = ".", row.names = T, col.names = T)

save.image("fertred.RData")
